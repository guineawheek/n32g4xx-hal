...
impl<const P: char, const N: u8, Otype> IoPin<Pin<P, N, Input<Floating>>, Self> for Pin<P, N, Output<Otype>>
where
...
impl<const P: char, const N: u8, Otype> IoPin<Pin<P, N, Input<PullDown>>, Self> for Pin<P, N, Output<Otype>>
where
    Output<Otype>: PinMode,
{
    type Error = Infallible;
...
impl<const P: char, const N: u8, Otype> IoPin<Pin<P, N, Input<PullUp>>, Self> for Pin<P, N, Output<Otype>>
where
    Output<Otype>: PinMode,
{
    type Error = Infallible;
...
impl<const P: char, const N: u8, Otype> IoPin<Self, Pin<P, N, Output<Otype>>> for Pin<P, N, Input<Floating>>
where
    Output<Otype>: PinMode,
{
    type Error = Infallible;
...
impl<const P: char, const N: u8, Otype> IoPin<Self, Pin<P, N, Output<Otype>>> for Pin<P, N, Input<PullDown>>
where
    Output<Otype>: PinMode,
{
    type Error = Infallible;
...
impl<const P: char, const N: u8, Otype> IoPin<Self, Pin<P, N, Output<Otype>>> for Pin<P, N, Input<PullUp>>
where
    Output<Otype>: PinMode,
{
    type Error = Infallible;
