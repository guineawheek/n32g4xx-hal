...
pub use super::{Ch, C1, C2, C3, C4, C5, C6};
...
pub type Channel5<TIM, const COMP: bool = false> = ChannelBuilder<TIM, C5, COMP, PushPull>;
pub type Channel6<TIM, const COMP: bool = false> = ChannelBuilder<TIM, C6, COMP, PushPull>;
...
pub type Channel5OD<TIM, const COMP: bool = false> = ChannelBuilder<TIM, C5, COMP, OpenDrain>;
pub type Channel6OD<TIM, const COMP: bool = false> = ChannelBuilder<TIM, C6, COMP, OpenDrain>;
